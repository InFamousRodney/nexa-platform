...
FR-AUTH-03: [Status: [✓ Geïmplementeerd]] Gebruikers moeten hun NEXA account kunnen koppelen aan één of meerdere Salesforce orgs via een veilige OAuth 2.0 PKCE flow.
...
AC-AUTH-03-01: [Status: [✓ Geïmplementeerd]] (Start Koppeling)
AC-AUTH-03-02: [Status: [✓ Geïmplementeerd]] (Succesvolle Autorisatie)
AC-AUTH-03-03: [Status: [✓ Geïmplementeerd]] (Veilige Opslag)
AC-AUTH-03-04: [Status: [✓ Geïmplementeerd]] (Foutafhandeling)
